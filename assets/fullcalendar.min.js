...
!function(t) {
    ...
    Fe.mixin({
        buildGotoAnchorHtml: function(e, n, i) {
            ...
            n = n ? " " + rt(n) : "",
            i = i || "",
            !o && this.opt("navLinks") ? "<a" + n + ' data-goto="' + et(JSON.stringify(a)) + '">' + i + "</a>" : "<span" + n + ">" + i + "</span>"
        },
    ...
    var Dn = Wt.BasicView = Ae.extend({
        ...
        renderSkeletonHtml: function() {
            ...
            return '<table class="' + t.getClass("tableGrid") + '">' + (this.opt("columnHeader") ?
             '<thead class="fc-head"><tr><td class="fc-head-container ' + t.getClass("widgetHeader") + '">&nbsp;</td></tr></thead>' : "") + '<tbody class="fc-body"><tr><td class="' + t.getClass("widgetContent") + '"></td></tr></tbody></table>'
        },
